"""
ResNet for 1D signals -- PyTorch version
...
class ResNet1D(nn.Module):
    ...
    Input:
        X: (n_samples, in_channels, n_length)

    Output:
        out: (n_samples)

    Pararmetes:
        in_channels: dim of input
        base_filters: number of first filters, it will double at every 4 layers
    ...
    def forward(self, x):
        ...
        # residual blocks, every block has 2 conv
        for i_block in range(self.n_block):
